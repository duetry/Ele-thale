          ...
          >
            ...
            <div style={{ flex: 1, minWidth: 200 }}>
              ...
              >
                ...
                <span
                  style={{
                    ...
                    padding: "3px 10px",
                    borderRadius: 999,
                    background: isStoreActive ? "#dcfce7" : "#fee2e2",
                    color: isStoreActive ? "#16a34a" : "#dc2626",
                    border: `1px solid ${isStoreActive ? "#86efac" : "#fca5a5"}`,
                    letterSpacing: 0.5,
                  }}
                >
              ...
              >
                ...
                {storeTime && (
                  <p style={{ fontSize: 13, color: "#4b7c5e", margin: 0 }}>
                    🕐 {storeTime}
                  </p>
                )}
                {storePhone && (
